...
public class Blocks extends MinecraftAECore {
    ...
    public static final Block OAK_LEAVES = register("oak_leaves", new Block(BlockSettings.of(Material.WOOD).opaque(false), new CubeAllModel().setAllTextures("assets/textures/blocks/leaves_oak.png")));
}
