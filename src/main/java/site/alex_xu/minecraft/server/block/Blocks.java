...
public class Blocks extends MinecraftAECore {
    ...
    public static final Block WATER = register("water", new Block(BlockSettings.of(Material.FLUID), new FluidSource().setEnd("assets/textures/blocks/water_still_single.png").setSide("assets/textures/blocks/water_flow_single.png")));
}
