...
public class Blocks extends MinecraftAECore {
    ...
    public static final Block OAK_PLANKS = register("oak_planks", new Block(BlockSettings.of(Material.WOOD), new CubeAllModel().setAllTextures("assets/textures/blocks/planks_oak.png")));
